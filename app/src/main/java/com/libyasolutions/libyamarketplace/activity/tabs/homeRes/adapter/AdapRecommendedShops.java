...
public class AdapRecommendedShops extends RecyclerView.Adapter<AdapRecommendedShops.ViewHolder> {
    private Activity context;
    private ArrayList<ModelSingleItem> listCities;

    public AdapRecommendedShops(Activity context, ArrayList<ModelSingleItem> listNames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.items_my_shops, viewGroup, false);
