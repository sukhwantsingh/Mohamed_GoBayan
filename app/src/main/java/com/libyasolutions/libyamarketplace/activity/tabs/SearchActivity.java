...
//        }
    ...
    private void setData() {
        ...
        // set up city
        arrCities.clear();
        arrCities.add(new City("0", getString(R.string.all_cities)));
        ...
        // setup category
        arrCategory.clear();
        arrCategory.add(new Category("0", getString(R.string.all_categories)));
    ...
    private void onClickSearch() {
        ...
        if (isSelectShop)
            ((MainTabActivity) getParent()).gotoActivity(
                    SearchShopResultActivityNew.class, b);
        else
            ((MainTabActivity) getParent()).gotoActivity(
                    SearchProductResuiltActivityNew.class, b);
    }
