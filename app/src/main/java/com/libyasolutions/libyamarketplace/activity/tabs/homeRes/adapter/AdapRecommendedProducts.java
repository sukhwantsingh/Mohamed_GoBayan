...
public class AdapRecommendedProducts extends RecyclerView.Adapter<AdapRecommendedProducts.ViewHolder> {
    private Activity context;
    private ArrayList<ModelSingleItem> listCities;

    public AdapRecommendedProducts(Activity context, ArrayList<ModelSingleItem> listNames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.items_my_products, viewGroup, false);
