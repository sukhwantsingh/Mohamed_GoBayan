...
public class AdapShopsNearbyYou extends RecyclerView.Adapter<AdapShopsNearbyYou.ViewHolder> {
    private Activity context;
    private ArrayList<ModelSingleItem> listCities;

    public AdapShopsNearbyYou(Activity context, ArrayList<ModelSingleItem> listNames) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.items_my_favourite_shops, viewGroup, false);
