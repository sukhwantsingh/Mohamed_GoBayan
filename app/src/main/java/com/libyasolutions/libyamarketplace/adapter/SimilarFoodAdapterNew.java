...
public class SimilarFoodAdapterNew extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SimilarFoodAdapterNew(RecyclerView recyclerView, Context context, List<ProductDetailResponse.SimilarFood> menuArrayList) {
